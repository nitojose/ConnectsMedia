...
export default function index() {
    ...
    return (
        <Container style={{paddingBottom:'10rem'}} className='my-5 padding-top padding-top-60'>
            <Parallax speed={-2.5}>
             ...
             <Row className='margin-top-53'>
                ...
                <Col xl={4} sm={12} md={12} xxl={4} className=''>
                        ...
                        <Card heading="Standard" month="month" rating="2.4" ratingColor="#E4115E" img={pink} speed="-4.2"></Card>
                 ...
                 <Col xl={4} sm={12} md={12} xxl={4} className=''>
                        ...
                        <Card heading="Customized" month="month" rating="3.5" ratingColor="#0EAE83" img={green} speed="-4.2"></Card>
