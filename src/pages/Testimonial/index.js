...
<div className="section scrollbar" id="testimonials">
	<div>
    <h2>Testimonials</h2>

	<div id="txt-version">
    	<div className="nav prev"><i class="fa fa-chevron-left" aria-hidden="true"></i></div>
        <ul className="content">
            ...
            <cite className="author">Mr. Patrick M</cite>
            </blockquote>
        ...
        <div className="nav next"><i class="fa fa-chevron-right" aria-hidden="true"></i></div>
    </div>
